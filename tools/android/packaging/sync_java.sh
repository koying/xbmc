...
find $TMP_DIR -name "*.in" |xargs -i sed -i -e "s#${VARIABLES[APP_PACKAGE]}#@APP_PACKAGE@#g" -e "s#${VARIABLES[APP_NAME]}#@APP_NAME@#g" -e "s#${APP_NAME_LC}#@APP_NAME_LC@#g" -e "s#${VARIABLES[VERSION_CODE_ANDROID]}#@APP_VERSION_CODE_ANDROID@#g" -e "s#${APP_VERSION}#@APP_VERSION@#g" {}
